...
Almost three years ago, I wrote a [blog post](https://bkhmsi.medium.com/egyptians-in-ai-research-1ff64c78cc5b) about why I built a small website called *“Egyptians in AI Research.”* It started with a simple question someone asked me: *“Are there Egyptians doing serious research in this field?”*
...
As I traveled for conferences to present my work, I started meeting people who knew me because of the website — not the other way around. I was invited to give a [TEDx talk](https://www.youtube.com/watch?v=PtdyHfpzodg) about why I created it. I received emails from students and researchers, thanking me for making something like that for the community.
...
In my [TEDx talk](https://www.youtube.com/watch?v=PtdyHfpzodg), I made a simple request.
...
Soon after, I received messages from people who created other similar projects — like **“[Moroccans in AI Research](https://mair.ma)”** and **“[Pakistanis in AI Research](https://ahmadmustafaanis.github.io/Pakistanis-in-ai/)”** — each one trying, in its own way, to make its community visible and heard.
...
The expansion of this website would not have been possible without **[Mohamed Dawoud](https://momodawoud.github.io)**, who helped enormously in growing, cleaning, organizing, and shaping the website. What started as a personal side project became a collaborative effort, and that shift mattered.

It changed the nature of the project, from something I was maintaining alone, to something that felt more like a shared responsibility toward a community.
What’s New
...
- A [statistics page](https://egyptians-in-cs.github.io/#/en/stats) visualizing key distributions within the community (academia vs. industry, research areas, positions, etc.)
...
It has been three years since I launched the Egyptians in AI website, and wrote this accompanying blog post explaining why I decided to create it. In a nutshell, I was dreaming of a world where Egyptian scientists are appreciated and known for their work especially given the AI boom that started with the launch of ChatGPT at the end of 2022. The idea got kindled in my brain when a family member asked me: “Are there known Egyptian researchers in AI?” This question made me realize the extent to which people do not know the people from their own country who were at the cutting edge of a technology that is changing the world as we know it. 

just as people know actors and singers in the entertainment industry. I was aware that this was a far fetched goal, but I was hoping to attempt to close this gap, at least

I did not expect it to resonate with people as much as it did.

—

Three years ago, I launched the Egyptians in AI website along with a short blog post explaining why I felt the need to create it. It was driven by a simple hope: that Egyptian scientists would be better known and appreciated for their contributions, especially as AI began entering the mainstream with the release of ChatGPT in late 2022. 

The idea began with a question from a family member: “Are there any famous Egyptian researchers in AI?” I didn’t struggle because the answer was no — I struggled because the answer was yes, and yet most people didn’t know them. That moment made me realize how invisible many world-class Egyptian researchers were, even to their own communities.
